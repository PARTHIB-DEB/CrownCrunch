...
export default function NavBar() {
    // For small Screen Hamburger rotation
    const HamRotate =() => {
        ...
        if(elem.onclick){
            if (elem.style.transform === 'rotate(0deg)') {
                ...
                ham.style.transform = 'translateY(-50rem)'
                ...
                <div className="small-nav flex justify-between items-center">
                    ...
                    >
                        <div className="name-menu flex justify-between">
                            <div className="hamburger inline-block p-1 cursor-pointer" onClick={HamRotate} id="ham">
